...
cswf <- collegedataplot2 %>%
  select(c('year','ComputerandInfoSciences'))

collegedatapwfplot2 <- waterfall(cswf,linetype = 1,rect_border = NA)
...
mswf <- collegedataplot2 %>%
  select(c('year','Mathandstatistics'))

collegedatapwfplot3 <- waterfall(mswf,linetype = 1,rect_border = NA)
